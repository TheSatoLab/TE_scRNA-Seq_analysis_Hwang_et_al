...
class GtfParser:
    ...
    def load_gtf(self, in_gtf_fn, fasta_parser=None):
        ...
        for gene, transcript_ids in gene_to_transcripts.iteritems():
            ...
            gc_content = np.median([transcript_gc_contents[transcript_id] for transcript_id in transcript_ids]) if fasta_parser is not None else float("nan")
...
class STAR:
    ...
    def align(self, read1_fastq_fn, read2_fastq_fn,
        ...
        args += ['--outFilterMultimapScoreRange','1',
